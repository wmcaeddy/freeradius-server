#!/usr/bin/env python3
"""
Setup script for demo tokens in PrivacyIDEA
Creates test users and tokens for demonstration purposes
"""
...
# Configuration
PRIVACYIDEA_URL = os.environ.get('PRIVACYIDEA_URL', 'http://localhost:80')
ADMIN_USER = os.environ.get('PI_ADMIN_USER', 'admin')
...
def setup_demo_tokens():
    ...
    log("")
    log("Test with: radtest demo <otp_value> radius-server 0 shared-secret")
